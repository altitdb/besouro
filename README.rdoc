...
These projects are not part of the plugin code itself. You can create them with eclipse wizzards if you prefer. They are being provided just for simplicity.
