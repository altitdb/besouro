 ...
 * @author Hongbing Kou
 */
public class TestAction extends ResourceAction {
	...
	public TestAction(Date clock, String workspaceFile) {
		super(clock, workspaceFile);
	}

	public TestAction(StringTokenizer tok) {
		super(tok);
	...
	public List<String> getActionDetails() {
		...
		details.add("subject: " + getSubjectName());
