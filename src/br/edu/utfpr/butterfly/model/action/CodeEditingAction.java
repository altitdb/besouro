 ...
 * @author Hongbing Kou
 */
public class CodeEditingAction extends ResourceAction {
	...
	public CodeEditingAction(Date clock, String workspaceFile) {
		super(clock, workspaceFile);
	}

	public CodeEditingAction(StringTokenizer tok) {
		super(tok);
